...
def get_command_line_parser():
    ...
    parser.add_argument('-epochs_new', type=int, default=150)
    ...
    parser.add_argument('-batch_size_new', type=int, default=500, help='set 0 will use all the availiable training image for new')
...
if __name__ == '__main__':
    ...
    trainer = importlib.import_module('models.%s.inc_trainer' % (args.project)).inc_trainer(args)
    trainer.train()